...
from nets.mix_transformer import mit_b1
from nets.yolo_training import (ModelEMA, YOLOLoss, get_lr_scheduler,
                                set_optimizer_lr, weights_init)
from utils.callbacks_orin import EvalCallback, LossHistory
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/home/bennyzhu/ILISTO/logs/IRDST/loss_2024_11_07_19_54_47/best/' 
    ...
    #train_annotation_path = '/home/bennyzhu/ILISTO/fewshot/ITSDT/train_400.txt'
    ...
    #train_annotation_path = '/home/public/IRDST/real/coco_train_IRDST.txt'
    #val_annotation_path = '/home/public/IRDST/real/coco_val_IRDST.txt'
    ...
    #vgg.load_state_dict(torch.load('/home/bennyzhu/StyTR-2-main/experiments/vgg_normalised.pth'))
    #torch.save(vgg.state_dict(), "vgg.pth" )
    #vgg = nn.Sequential(*list(vgg.children())[:44])
    #torch.save(vgg.state_dict(), "vgg.pth" )
    model = Model(num_classes=1, num_frame=4)
    #model.encoder.load_state_dict(torch.load('/home/bennyzhu/ILISTO/model_data/mit_b1_new.pth'))
    weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
    ...
    if True:
        ...
        #    'sgd'   : optim.SGD([ 
         #                     {'params': model.loss_s.parameters()},]      
          #                    , Init_lr_fit, momentum = momentum, nesterov=True, weight_decay = decay)
        #}[optimizer_type]
        #optimizer.add_param_group({ "weight_decay": weight_decay})
