...
#from nets.Network import Network as Model
...
class Pred_vid(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path_1"        : '/home/bennyzhu/ILISTO/logs/ITSDT/loss_2024_11_04_18_52_00/best/', 
        "model_path_2"        : '/home/bennyzhu/ILISTO/logs/DAUB/loss_2024_11_15_11_47_58/best/', 
    ...
    #   生成模型
    #---------------------------------------------------#
    def load_pth(self,model,model_path):
        ...
        model.loss_s.load_state_dict(torch.load(model_path + 'loss.pth', map_location=device))
        model.eval()
    ...
    def generate(self, onnx=False):
        self.net1    = Model(self.num_classes, num_frame=4).to('cuda')
        self.net2    = Model(self.num_classes, num_frame=4).to('cuda')
        self.net3    = Model(self.num_classes, num_frame=4).to('cuda')
        self.load_pth(self.net1, self.model_path_1)
        self.load_pth(self.net2, self.model_path_2)
        self.load_pth(self.net3, self.model_path_3)
    ...
    def detect_image(self, images, crop = False, count = False):
        ...
        #   计算输入图片的高和宽
        #---------------------------------------------------#
        img = self.resize_img(images[-1]).to('cuda')
...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        '''
        # while True:
        #img = '/home/bennyzhu/ILISTO/feature_vis/test/3.jpg'
        img = '/home/public/ITSDT/images/85/10.bmp'
        #img = '/home/public/IRDST/real/images/2/5.bmp'
        #img = '/home/public/DAUB/images/test/data6/40.bmp'
        try:
            ...
            r_image.save("/home/bennyzhu/ILISTO/detection/ITSDT_85_10.jpg")
            #r_image.save("/home/bennyzhu/ILISTO/detection/IRDST_2_5.jpg")
            #r_image.save("/home/bennyzhu/ILISTO/detection/DAUB_6_40.jpg")
            #r_image.save("/home/bennyzhu/ILISTO/detection/test.jpg")
